...
lc = 0.01; // Adjusted for finer mesh, change as needed
...
// Coupling Surfaces
Physical Surface("U_Channel_Fluid_Channel_Top") = {2};    // This seems to be tag 2 in your file
Physical Surface("U_Channel_Fluid_Channel_Right") = {3};  // This seems to be tag 3 in your file
Physical Surface("U_Channel_Fluid_Channel_Bottom") = {4}; // This seems to be tag 4 in your file

// Other Boundaries (THESE ARE MISSING)
Physical Surface("U_Channel_Fluid_Entry") = {5}; // Example: replace 5 with the correct tag
Physical Surface("U_Channel_Fluid_Outlet") = {6}; // Example: replace 6 with the correct tag
